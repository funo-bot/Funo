...
module.exports.run = async (funo, message, args) => {
  ...
  if (args[0]) {
    ...
    var array = await funo.commands.filter(c => c.help.name === args[0]).map(c => c.help.description).join();
